...
#include "stm32f0xx.h"
 ...
 /******************  FLASH Keys  **********************************************/
 #define FLASH__FKEY1                          ((uint32_t)0x45670123)        /*!< Flash program erase key1 */
 #define FLASH__FKEY2                          ((uint32_t)0xCDEF89AB)        /*!< Flash program erase key2: used with FLASH_PEKEY1
